...
#line 104 "uri.rl"
            {
                ...
                curi->setQuery(std::string(mark, p - mark));
                mark = NULL;
            }
            goto st453;
tr469:
...
#line 43 "uri.rl"
            {
                if (mark != NULL) {
                    //std::cout << std::string(mark, fpc - mark) << std::endl;
                    curi->setHost(std::string(mark, p - mark));
                }
            }
            goto st453;
tr485:
...
#line 78 "uri.rl"
            {
                //std::cout << std::string(mark, fpc - mark) << std::endl;
                curi->setPath(std::string(mark, p - mark));
                mark = NULL;
            }
            goto st453;
tr559:
...
#line 35 "uri.rl"
            {
                if(mark) {
                    //std::cout << std::string(mark, fpc - mark) << std::endl;
                    curi->setUserinfo(std::string(mark, p - mark));
                }
                mark = NULL;
            }
            goto st469;
...
#line 20 "uri.rl"
            {
                curi->setScheme(std::string(mark, p - mark));
                mark = NULL;
            }
            goto st509;
st509:
...
#line 110 "uri.rl"
                {
                    //std::cout << std::string(mark, fpc - mark) << std::endl;
                    curi->setFragment(std::string(mark, p - mark));
                    mark = NULL;
                }
                break;
            case 456:
